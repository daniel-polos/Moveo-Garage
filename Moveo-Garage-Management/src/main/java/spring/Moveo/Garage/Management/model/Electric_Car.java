...
public class Electric_Car extends Vehicle{
    public Electric_Car(@JsonProperty("modelName") String modelName, @JsonProperty("license_Number") int license_Number, @JsonProperty("available_Energy_Percentage") int available_Energy_Percentage, @JsonProperty("tire_Pressure") int tire_Pressure, @JsonProperty("max_Tire_Pressure") int max_Tire_Pressure){
        super(modelName, license_Number, available_Energy_Percentage, tire_Pressure, max_Tire_Pressure, 4, Energy_Source.BATTERY);
    }
